...
function Transaction(id, trans_model) {
    ...
    this.__defineGetter__("Rollback", function () {
        return async function () {
            ...
            await promify(trans_model.findByIdAndUpdate, trans_model)(id, { $set: { state: "rollback" } });
    ...
    this.__defineGetter__("Commit", function () {
        return async function () {
            //var models=[];
            await promify(trans_model.findByIdAndUpdate, trans_model)(id, { $set: { state: "commit" } });
